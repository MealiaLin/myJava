...
public class SnakeFrame extends Frame {
    ...
    public void displaySomeInfor(Graphics g){
        ...
        g.drawString("使用说明:按键盘的上下左右控制蛇的方向空格键---暂停，按键B---暂停后开始,F2---重新开始", 5*BLOCK_HEIGHT, 3*BLOCK_WIDTH);
        g.drawString("空格键---暂停，按键B---暂停后开始,F2---重新开始", 5*BLOCK_HEIGHT, 3*BLOCK_WIDTH);
